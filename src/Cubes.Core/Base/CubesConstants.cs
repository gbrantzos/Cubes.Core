namespace Cubes.Core.Base
{
    public static class CubesConstants
    {
        ...
        public const string Files_Applications                  = "Cubes.Applications.yaml";
        public const string Files_Application                   = "Application.yaml";
        ...
        public const string Config_HostManagementAppPackage     = "Host:ManagementAppPackage";
        public const string Config_HostManagementAppPackageRoot = "Host:ManagementAppPackageRoot";
        public const string Config_HostManagementAppRequestPath = "Host:ManagementAppRequestPath";

        public const string NLog_ConfigFile                     = "NLog.config";
        public const string NLog_SampleFile                     = "NLog.Sample.config";

        public const string Folders_Common                      = "Common";
